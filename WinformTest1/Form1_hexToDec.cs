...
namespace WinformTest1
{
...

    {
        ...
        private void serialPort1_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            for(int k=0; k< i_recv_size; k++)
            {
                que.Enqueue(b_tmp_buf[k]);
            }

            recv_str = string.Concat(Array.ConvertAll(b_tmp_buf, byt => byt.ToString("X2")));
        ...
        {
            string dec = Convert.ToInt32(strData, 16).ToString();
